...
HD_PWD='C:/Users/Mihir Shekhar/parallel_counter_project4/parallel_counter_project4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log par_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source par_counter.tcl

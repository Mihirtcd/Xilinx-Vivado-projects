...
HD_PWD='C:/Users/Mihir Shekhar/parallel_counter_project4/parallel_counter_project4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log par_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source par_counter.tcl -notrace
